...
echo " "
echo -e "\e[33m Welcome to [\e[1m\e[32mFLEXUS VIRUS\e[21m\e[31m V 2.3\e[33m]"
echo " "
sleep 1
echo -e "\e[1m\e[33m============================================\e[21m"
echo " "
echo -e "\e[33m•••Script by \e[36m@flexus_dev\e[33m•••"
echo " "
echo -e "\e[1m\e[33m••••••••••••••••••••••••••••••••••••••••••••\e[21m"
echo " "
sleep 1
echo -e "\e[92mПроверка покеты установлены!"
echo " "
echo -e "\e[1m\e[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\e[21m"
sleep 2
...
if [ $? -eq 0 ]; then
    ...
    echo -e "\e[92m • Figlet установлен ✅"
echo " "
    else
    echo " "
        echo -e "\e[31m • Установка Figlet..."
        echo " "
        sleep 1
...
if [ $? -eq 0 ]; then
    echo -e "\e[92m • Pv установлен ✅"
echo " "
else
    echo -e "\e[31m • Установка Pv..."
            echo " "
            sleep 1
        pkg install pv -y
        echo " "
...
if [ $? -eq 0 ]; then
    echo -e "\e[92m • Man установлен ✅"
            echo " "
else
    echo -e "\e[31m • Установка Man..."
            echo " "
            sleep 1
        pkg install man -y
        echo " "
...
echo -e "\e[1m\e[33m^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^\e[21m"
    echo " " 
                    echo -e "\e[36m >>> ЗАПУСК FLEXUS VIRUS..."
                    echo " "
                    sleep 2
...
echo " "
echo -e "\e[93m\e[44mНажимая на Enter, вы соглашаетесь с тем, что"|pv -qL 20
echo -e "\e[44mЭТОТ ИНСТРУМЕНТ ИСПОЛЬЗУЕТСЯ ТОЛЬКО В     "|pv -qL 20
echo -e "\e[44m   ОБРОЗОВАТЕЛЬНЫХ ЦЕЛЯХ          "|pv -qL 20
echo -e "\e[49m"
echo -e "\e[1m\e[91m××××××××××××××××××××××××××××××××××××××××××××\e[21m"
sleep 1
echo -e "\e[92m "
read -r -s -p $'Нажмите Enter, чтобы продолжить...\n'
clear
...
echo -e "\e[33m "
read -p "ВЫБЕРИТЕ ОПЦИЮ : " optionfirst
if [ $optionfirst -eq 2 ]
then 
clear   
echo -e "\e[1m\e[35m¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥¥\e[21m"
...
echo " "
echo -e "\e[95m%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
echo "•••Извините пожалуйста, выберите правильный ВАРИАНТ•••"
echo -e "\e[95m%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
fi
...
echo " "
echo -e "\e[95m%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
echo "•••Извините пожалуйста, выберите правильную ОПЦИЮ•••"
echo -e "\e[95m%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
fi
elif [ $option1 -eq 4 ]
then 
...
echo " "
echo -e "\e[95m%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
echo "•••Простите, выберите опцию 1 или 2 или 3 или 4•••"
echo -e "\e[95m%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
fi
...
echo " "
echo -e "\e[95m%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
echo "•••Простите выберите опцию 1 или 2•••"
echo -e "\e[95m%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%"
fi                                                                                                                                                    
...
echo -e "\e[92m========================================== "
echo -e "\e[93m[1] Назад"
echo -e "\e[93m[2] Выйти "

echo -e "\e[92m "
read -p "ВЫБЕРИТЕ ОПЦИЮ : " be 
if [ $be -eq 1 ]
then
back_option
elif [ $be -eq 2 ]
...
echo -e "\e[95m÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷"
echo -e "\e[103m     •••БОЛЬШЕ ПОДРОБНОСТЕЙ•••. "
echo -e "\e[103mИЩИТЕ  *@flexus_dev и @DarkKRk*"
echo -e "\e[103m       •••В ТГ•••      \e[49m"
echo -e " \e[39m"
echo -e "\e[95m÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷÷"
echo -e "\e[39m"
